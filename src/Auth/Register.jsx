 ...
 const [passwordMessage, setPasswordMessage] = useState('')
  ...
  const handlesubmit = async (e) => {
    ...
    if(userData.profile_image){
       ...
       toast.warning("image profile is requsted")
       return
    }    
    ...
    await axios.post("https://vica.website/api/register", formdata, {
  ...
  return (
    <div className="relative   bg-white  flex justify-center items-center">
      <img
        ...
        alt=""
        className="hidden md:block min-h-screen w-full object-cover absolute -z-1  "
      />
      <div className=" max-w-3xl w-full  top-4   md:w-[760px]  bg-white relative rounded-2xl">
        ...
        >
          <div className="flex flex-col md:flex-row  gap-4 ">
            <label
              htmlFor=""
              className="flex flex-col text-lg text-subtitle w-full  "
            >
              First Name
              <input
                type="text"
          ...
          <div className="flex flex-col md:flex-row   gap-5  ">
            <label
              htmlFor=""
              className="flex flex-col w-full  text-lg text-subtitle "
            >
              Password:
              <input
                type="password"
            ...
            <label
              htmlFor=""
              className="flex flex-col w-full text-subtitle  text-lg  "
            >
              confirm password:
              <input
                type="password"
          ...
          <label
            htmlFor=""
            className="cursor-pointer relative text-subtitle  text-lg flex flex-col items-center md:items-start"
          >
            Profile Image:
            <img
              src={
          ...
          <div className="flex items-center flex-col mt-4 gap-1  ">
            <button
              className="  px-28 py-3 m-auto bg-blue-1  hover:bg-blue-600 duration-150 
           rounded-lg text-white text-2xl font-semibold text-center opacity-90 "
              type="submit"
            >
              Sign Up
            </button>
            <p className=" text-subtitle">
              ...
              <Link to="login" className="underline text-blue-1 ">
                Login
              </Link>
            </p>
          </div>
